...
const About = () => {
  ...
  const expertisePillars = [
    {
      ...
      description: 'Building intelligent systems with Python, PyTorch & TensorFlow',
  ...
  const stats = [
    { label: 'Years Innovating', value: yearsExperience, suffix: '+', icon: FiAward },
    { label: 'Projects Delivered', value: projectsCount, suffix: '+', icon: FiTarget },
    { label: 'Certifications', value: totalCertifications, suffix: '+', icon: FiCheckCircle },
    { label: 'Global Languages', value: languageSkills.length, suffix: '', icon: FiGlobe }
  ];

  const timeline = [
    { year: '2018', event: 'Electrical Engineering Degree', description: 'Specialized in automation & control systems' },
    { year: '2020', event: 'AI/ML Specialization', description: 'Began professional journey in machine learning' },
    { year: '2022', event: 'IBM Certifications', description: 'Completed multiple IBM data science certifications' },
    { year: '2023', event: 'Advanced Projects', description: 'Led complex ML projects in predictive analytics' }
  ];

  return (
    <section ref={sectionRef} className="relative min-h-screen py-24 bg-gradient-to-b from-gray-900 via-gray-800 to-black overflow-hidden">
      ...
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-tl from-blue-500/5 to-transparent rounded-full blur-2xl animate-float-slow" style={{ animationDelay: '1s' }} />

      <div className="container mx-auto px-4 relative z-10">
        
        {/* Hero Header */}
        <div className="text-center mb-20">
          <div className={`inline-flex items-center gap-2 bg-gradient-to-r from-primary-500/20 to-blue-500/20 backdrop-blur-sm px-6 py-3 rounded-2xl border border-primary-500/30 mb-6 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10'}`}>
            <FiZap className="text-primary-300 animate-pulse" />
            <span className="text-primary-200 font-medium tracking-wider">THE INNOVATOR'S PROFILE</span>
          </div>
          
          <h1 className={`text-5xl md:text-7xl font-bold mb-6 leading-tight transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10'}`}>
          ...
          <p className={`text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10'}`}>
            Bridging the gap between complex data problems and elegant AI solutions. 
            With {yearsExperience}+ years of transforming theoretical concepts into production-ready systems.
          </p>
        </div>

        {/* Stats Bar */}
        <div className={`grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16 transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <div key={index} className="group relative">
                ...
                <div className="relative bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700/50 rounded-2xl p-6 backdrop-blur-sm hover:border-primary-500/50 transition-all duration-300">
                  <div className="flex items-center gap-3 mb-4">
                    <div className={`p-2 bg-gradient-to-br ${stat.icon === FiAward ? 'from-yellow-500/20 to-yellow-600/20' : stat.icon === FiTarget ? 'from-green-500/20 to-green-600/20' : stat.icon === FiCheckCircle ? 'from-blue-500/20 to-blue-600/20' : 'from-cyan-500/20 to-cyan-600/20'} rounded-lg`}>
                      <Icon className={`${stat.icon === FiAward ? 'text-yellow-400' : stat.icon === FiTarget ? 'text-green-400' : stat.icon === FiCheckCircle ? 'text-blue-400' : 'text-cyan-400'} text-xl`} />
                    </div>
                    <div>
                  ...
                  <div className="h-1 bg-gradient-to-r from-gray-700 to-gray-800 rounded-full overflow-hidden">
                    <div 
                      ...
                      style={{ width: isVisible ? `${Math.min(100, stat.value * 5)}%` : '0%' }}
                    />
                  </div>
                </div>
              </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className={`bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-3xl p-8 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            {/* Journey Timeline */}
            <div className={`bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-3xl p-8 transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
                    ...
                    >
                      <div className="relative z-10">
                        <div className="w-12 h-12 bg-gradient-to-br from-gray-800 to-gray-900 border-2 border-gray-700 rounded-full flex items-center justify-center group-hover:border-primary-500 transition-all duration-300">
                          <span className="text-primary-300 font-bold">{item.year}</span>
                        </div>
                      </div>
          ...
          <div className="space-y-8">
            {/* Languages Card */}
            <div className={`bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-3xl p-8 h-fit transition-all duration-1000 delay-800 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
              <h2 className="text-3xl font-bold text-white mb-8 flex items-center gap-3">
                ...
                {languageSkills.map((lang, index) => (
                  <div key={index} className="group">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm text-gray-300">{lang.level}%</span>
                    </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-700/50">
                <p className="text-gray-400 text-sm italic">
                  "Effective communication across cultures enhances collaboration and innovation."
                </p>
              </div>
            </div>

            {/* CTA Card */}
            <div className={`relative overflow-hidden rounded-3xl transition-all duration-1000 delay-1000 ${isVisible ? 'opacity-100 translate-x-0 scale-100' : 'opacity-0 translate-x-10 scale-95'}`}>
              ...
              <div className="relative z-10 p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-white">Ready to Innovate?</h3>
                    <p className="text-primary-200">Let's build something extraordinary</p>
                  </div>
                </div>
                
                <p className="text-white/80 mb-8 leading-relaxed">
                  Every great innovation begins with a conversation. Let's combine your vision with my technical expertise to create AI solutions that redefine possibilities.
                </p>
        ...
        <div className={`text-center mt-16 transition-all duration-1000 delay-1100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="inline-block bg-gradient-to-r from-primary-500/10 via-blue-500/10 to-cyan-500/10 backdrop-blur-sm border border-gray-700/50 rounded-2xl px-8 py-6">
            <p className="text-2xl text-white/90 italic leading-relaxed">
              "In the symphony of data, I conduct algorithms that transform noise into harmony, 
              crafting intelligent solutions that don't just predict the future — they shape it."
            </p>
            <div className="mt-4 flex items-center justify-center gap-2">
              <div className="h-0.5 w-12 bg-gradient-to-r from-primary-500 to-blue-500" />
              <span className="text-primary-300 font-medium">— Naceur Keraani</span>
