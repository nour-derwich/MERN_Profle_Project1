  ...
  const handleToggleFeatured = async (project) => {
    try {
      ...
      setProjects(prev => 
        prev.map(p => 
          p.id === project.id 
            ? { ...p, featured: response.data.featured }
            : p
        )
      );
    } catch (error) {
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Manage your portfolio projects, update status, and feature important work.
            </p>
          </div>
          <div className="flex items-center space-x-3">
            {/* Bulk Actions */}
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
          <div className="flex items-center justify-between">
            ...
            <div className="w-12 h-12 bg-purple-100 rounded-2xl flex items-center justify-center">
              <span className=" from-blue-900 via-blue-800 to-blue-700  text-xl">⭐</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900">
                {projects.reduce((total, project) => total + (project.views_count || 0), 0)}
              </p>
            </div>
