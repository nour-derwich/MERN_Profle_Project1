      ...
      <div className="flex-1 ml-64 p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-gray-500 text-sm font-semibold uppercase">Total Courses</p>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-gray-500 text-sm font-semibold uppercase">Featured</p>
                <h3 className="text-3xl font-bold text-gray-900 mt-2">{stats.featured || 0}</h3>
              </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all">
            <div className="flex justify-between items-start">
              <div>
                ...
                <h3 className="text-3xl font-bold text-gray-900 mt-2">{stats.totalClicks || 0}</h3>
              </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all">
            <div className="flex justify-between items-start">
              <div>
                ...
                <h3 className="text-3xl font-bold text-gray-900 mt-2">{stats.categories || 0}</h3>
              </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">Get started by adding your first course or book</p>
            <button
              onClick={() => navigate('/admin/courses/new')}
