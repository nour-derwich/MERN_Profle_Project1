...
import { FiAward, FiBriefcase, FiCode, FiTrendingUp, FiShield } from 'react-icons/fi';
...
const Qualifications = () => {
  ...
  const experience = [
    {
      ...
      technologies: ['Python', 'PyTorch', 'TensorFlow', 'Pandas', 'NumPy', 'React']
    },
    {
      id: 2,
  ...
  const stats = [
    { value: '10+', label: 'Certifications', icon: FiAward, color: 'from-blue-500 to-cyan-500' },
    { value: '3+', label: 'Years Experience', icon: FiBriefcase, color: 'from-green-500 to-emerald-500' },
    { value: '15+', label: 'Projects Delivered', icon: FiCode, color: 'from-purple-500 to-pink-500' },
    { value: '7+', label: 'IBM Certificates', icon: SiIbm, color: 'from-orange-500 to-red-500' }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black">
      ...
      <QualificationModal selectedItem={selectedItem} setSelectedItem={setSelectedItem} />
