            ...
            <div className="flex justify-center items-center gap-8">
              {techIcons.map((tech, index) => {
                ...
                return (
                  ...
                  >
                    {/* Glow Effect */}
                    <div className={`absolute -inset-4 bg-gradient-to-br ${tech.color} rounded-full blur-xl opacity-0 ${isActive ? 'opacity-30' : ''
                    ...
                    <div className={`relative p-6 bg-gradient-to-br from-gray-800 to-gray-900 border ${isActive ? 'border-primary-500/50' : 'border-gray-700/50'
                      } rounded-2xl backdrop-blur-sm transform ${isActive ? 'rotate-0' : 'rotate-12'
                      } transition-all duration-700`}>
                      <Icon className="text-5xl text-white" />
                    </div>

                    {/* Label */}
                    <div className={`absolute -bottom-6 left-1/2 -translate-x-1/2 text-sm font-medium whitespace-nowrap transition-all duration-700 ${isActive ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'
                      }`}>
