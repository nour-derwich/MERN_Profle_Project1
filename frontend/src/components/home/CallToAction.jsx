  ...
  return (
    <section className="relative py-24 overflow-hidden bg-gradient-to-b from-gray-900 via-black to-gray-900">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-20 right-20 w-80 h-80 bg-gradient-to-tl from-blue-500/10 to-transparent rounded-full blur-3xl animate-pulse-slow"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
              Every great innovation begins with a conversation. Let's combine
              your vision with my expertise to create intelligent solutions that
              push boundaries and deliver real impact.
            </p>
          </div>
                ...
                {isSubmitted ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-400">
                      I'll get back to you shortly. Check your email for
                      confirmation.
                    </p>
                    <button
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <div className="absolute left-4 top-1/2 -translate-y-1/2">
                          <FiUser
                            className={`${errors.name ? "text-red-400" : "text-gray-500"}`}
                          />
                        </div>
                        <input
                          type="text"
                          ...
                          required
                          className={`w-full pl-12 pr-4 py-4 bg-gradient-to-br from-gray-800 to-gray-900 border ${
                            errors.name
                              ? "border-red-500/50"
                              : "border-gray-700/50"
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <div className="absolute left-4 top-4">
                          <FiSend
                            className={`${errors.message ? "text-red-400" : "text-gray-500"}`}
                          />
                        </div>
                        <textarea
                          name="message"
              ...
              <div className="grid grid-cols-2 gap-4">
                {contactMethods.map((method) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`absolute inset-0 bg-gradient-to-r ${method.gradient} rounded-2xl opacity-0 ${
                      ...
                      <div className="relative z-10">
                        ...
                        <h4
                          className={`font-bold mb-2 ${isActive ? "text-white" : "text-gray-300"}`}
                        >
                          {method.title}
                        </h4>

                        <div
                          className={`text-sm mb-1 ${isActive ? "text-gray-300" : "text-gray-500"}`}
                        >
                          {method.value}
                        </div>
                    ...
                    .map((method) => {
                      ...
                      return (
                        <div key={method.id} className="space-y-3">
                          ...
                          <div className="text-xs text-gray-500 text-center">
                            {method.id === "email" &&
                              "Perfect for detailed project briefs"}
                            {method.id === "whatsapp" &&
                              "Ideal for quick questions and updates"}
                            {method.id === "telegram" &&
                              "Great for sharing files and code snippets"}
                            {method.id === "location" &&
