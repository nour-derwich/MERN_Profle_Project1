...
import { FaChalkboardTeacher, FaGraduationCap, FaPython } from "react-icons/fa";
import {
  FiArrowLeft,
  FiAward,
  FiBarChart2,
...
const FormationDetail = ({
  ...
  const [isFavorite, setIsFavorite] = useState(
    favorites.includes(selectedFormation?.id)
  );
  ...
  const formationData = {
    ...
    duration:
      ...
      (selectedFormation.duration_hours
        ? `${parseNumber(selectedFormation.duration_hours)} hours`
        : "Flexible"),
    ...
    spotsLeft:
      selectedFormation.spots_left !== undefined
        ? parseNumber(selectedFormation.spots_left, 0)
        : Math.max(
            0,
            parseNumber(selectedFormation.max_participants, 0) -
              parseNumber(selectedFormation.current_participants, 0)
          ),
    ...
    description:
      ...
      selectedFormation.short_description ||
    ...
    learning_objectives: Array.isArray(selectedFormation.learning_objectives)
      ...
      : typeof selectedFormation.learning_objectives === "string"
        ? selectedFormation.learning_objectives
            ...
            .filter((lo) => lo.trim())
        : [],
    modules: Array.isArray(selectedFormation.modules)
      ? selectedFormation.modules
      : [],
    testimonials: Array.isArray(selectedFormation.testimonials)
      ? selectedFormation.testimonials
      : [],
    ...
    instructor: selectedFormation.instructor_name
      ? {
          ...
          avatar:
            selectedFormation.instructor_photo ||
            getInstructorAvatar(
  ...
  const stats = [
    {
      ...
      label: "Duration",
      value:
        formationData.duration_hours > 0
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex flex-wrap items-center gap-3 mb-6">
                ...
                <div className="w-1 h-1 bg-gray-700 rounded-full" />
                <div
                  className={`px-3 py-1 bg-gradient-to-r ${getLevelColor(formationData.level)} text-white text-xs font-bold rounded-full`}
                >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      <h3 className="font-bold text-white">
                        Instructor: {formationData.instructor.name}
                      </h3>
                    ...
                    <p className="text-sm text-gray-400">
                      {formationData.instructor.title}
                    </p>
                    <div className="flex items-center gap-2 mt-2">
                      <div className="flex items-center gap-1">
                        <FiStar className="text-yellow-400 fill-yellow-400 text-sm" />
                        <span className="text-sm text-gray-400">
                          {formationData.instructor.rating?.toFixed(1) || "0.0"}{" "}
                          ({formationData.instructor.reviews || 0} reviews)
                        </span>
                      </div>
                      <div className="w-1 h-1 bg-gray-700 rounded-full" />
                      <span className="text-sm text-gray-400">
              ...
              <div className="flex flex-wrap gap-4">
                <button
                  ...
                  disabled={
                    formationData.status === "full" ||
                    formationData.spotsLeft <= 0
                  }
                ...
                <div className="relative">
                  ...
                  <div className="relative bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700/50 rounded-2xl p-6 backdrop-blur-sm">
                    ...
                    <div className="text-center mb-6">
                      ...
                      {formationData.originalPrice &&
                        formationData.originalPrice > formationData.price && (
                      ...
                      {formationData.installment &&
                        formationData.installment > 0 && (
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            >
              ...
              formationData.highlights.length > 0 ? (
                <div className="grid md:grid-cols-2 gap-4">
                  {formationData.highlights.map((highlight, idx) => (
                    <div
                      key={idx}
                      className="flex items-start gap-3 p-4 bg-gray-800/30 rounded-xl hover:bg-gray-800/50 transition-all duration-300"
                    >
                ...
                formationData.learning_objectives.length > 0 ? (
                <div className="grid md:grid-cols-2 gap-4">
              ...
              >
                ...
                <div className="space-y-4">
                  {formationData.modules.map((module, idx) => (
                    <div
                      key={idx}
                      className="border border-gray-700/50 rounded-xl p-6 hover:border-primary-500/30 transition-all duration-300"
                    >
            ...
            {formationData.prerequisites &&
              formationData.prerequisites.length > 0 && (
                <motion.div
                  id="prerequisites"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {formationData.prerequisites.map((prereq, idx) => (
                      <div
                        key={idx}
                        className="flex items-start gap-3 p-4 bg-gray-800/30 rounded-xl"
                      >
            ...
            {/* Testimonials */}
            {formationData.testimonials &&
              formationData.testimonials.length > 0 && (
                <motion.div
                  id="testimonials"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
