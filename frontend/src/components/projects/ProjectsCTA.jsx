  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Call the onStartProject callback if provided
        if (onStartProject) {
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-6 mt-8">
            ...
            <a
              href="https://linkedin.com/in/naceur-keraani"
              target="_blank"
              rel="noopener noreferrer"
      ...
      {formVisible && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div
            ...
            onClick={() => !isSubmitting && setFormVisible(false)}
          />
            ...
            {submitSuccess ? (
              <div className="p-8 text-center">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-gradient-to-r from-primary-500 to-blue-600 text-white rounded-xl font-semibold hover:shadow-2xl transition-all duration-300"
                >
                  Close
                </button>
              </div>
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleInputChange}
                          disabled={isSubmitting}
                          className="w-full px-4 py-3 bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700/50 text-white rounded-xl focus:border-primary-500/50 focus:outline-none transition-all duration-300 disabled:opacity-50"
                        >
                  ...
                  <div className="flex gap-3 mt-8 pt-6 border-t border-gray-700/50">
                    <button
                      ...
                      onClick={() => setFormVisible(false)}
                      disabled={isSubmitting}
                      className="flex-1 px-6 py-3 bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700/50 text-gray-400 rounded-xl hover:text-white hover:border-gray-600/50 transition-all duration-300 disabled:opacity-50"
                    >
                      Cancel
                    </button>
                    <button
                      type="submit"
                      disabled={isSubmitting}
                      className="flex-1 px-6 py-3 bg-gradient-to-r from-primary-500 to-blue-600 text-white rounded-xl font-semibold hover:shadow-2xl transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isSubmitting ? (
                        <>
