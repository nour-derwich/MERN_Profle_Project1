  ...
  const defaultCategories = [
    {
      ...
      count: Array.isArray(filteredProjects) ? filteredProjects.length : 0,
    },
    {
      ...
      count: Array.isArray(filteredProjects)
        ? filteredProjects.filter((p) => p.category === "Machine Learning")
            .length
        : 0,
    },
    {
      ...
      count: Array.isArray(filteredProjects)
        ? filteredProjects.filter((p) => p.category === "Deep Learning").length
        : 0,
    },
    {
      value: "Data Science",
      ...
      count: Array.isArray(filteredProjects)
        ? filteredProjects.filter((p) => p.category === "Data Science").length
        : 0,
    },
    {
      value: "Web Apps",
      ...
      count: Array.isArray(filteredProjects)
        ? filteredProjects.filter((p) => p.category === "Web Apps").length
        : 0,
    },
    {
      value: "APIs",
      ...
      count: Array.isArray(filteredProjects)
        ? filteredProjects.filter((p) => p.category === "APIs").length
        : 0,
    },
    {
      ...
      color: "from-blue-500 to-cyan-600",
      count: Array.isArray(filteredProjects)
        ? filteredProjects.filter((p) => p.category === "Computer Vision")
            .length
        : 0,
    },
    {
      ...
      count: Array.isArray(filteredProjects)
        ? filteredProjects.filter((p) => p.category === "AI Finance").length
        : 0,
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative max-w-3xl mx-auto mb-6">
          <div className="relative group">
            ...
            {/* Search Container */}
            <div
              className={`relative flex items-center bg-gradient-to-br from-gray-800 to-gray-900 border ${
                ...
                {(() => {
                  ...
                  return (
                    <>
                      ...
                      <FiChevronDown
                        className={`text-sm transition-transform duration-300 ${showSortDropdown ? "rotate-180" : ""}`}
                      />
                    </>
                  );
                })()}
          ...
          {allCategories.map((category) => {
            ...
            return (
              ...
              >
                {/* Glow Effect */}
                <div
                  className={`absolute -inset-0.5 bg-gradient-to-r ${getFilterColor("category", category.value)} rounded-xl blur opacity-0 ${
                ...
                {/* Button */}
                <div
                  className={`relative flex items-center gap-2 px-4 py-3 rounded-xl backdrop-blur-sm transition-all duration-300 ${
                    isActive
                      ...
                      {complexities.map((complexity) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              className={`w-2 h-2 rounded-full ${isActive ? "bg-white" : "bg-gray-700 group-hover:bg-gray-600"}`}
                            />
                          </button>
                        );
                      })}
                  ...
                  {advancedFilters.map((filter) => {
                    ...
                    return (
                      <button
                        key={filter.id}
                        onClick={() =>
                          onAdvancedFilter && onAdvancedFilter(filter.id)
                        }
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {selectedComplexity !== "all" && (
                <div className="flex items-center gap-1 px-3 py-1.5 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border border-blue-500/30 text-blue-300 rounded-lg text-sm">
                  ...
                  <span>
                    {
                      complexities.find((l) => l.id === selectedComplexity)
                        ?.label
                    }
                  </span>
                  <button
