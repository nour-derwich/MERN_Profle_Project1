      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <FiFilter
                className={isFiltersExpanded ? "text-white" : "text-gray-400"}
              />
                ...
                <div className="flex flex-wrap gap-2">
                  {categories.map((category) => (
                    ...
                    >
                      ...
                      <div
                        className={`absolute -inset-0.5 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg blur opacity-0 ${
                          selectedCategory === category.value
                            ? "opacity-20"
                ...
                <div className="flex flex-wrap gap-2">
                  {levels.map((level) => (
                    ...
                    >
                      ...
                      <div
                        className={`absolute -inset-0.5 bg-gradient-to-r ${level.color} rounded-lg blur opacity-0 ${
                          selectedLevel === level.id
                            ? "opacity-20"
                            : "group-hover:opacity-10"
                        } transition-opacity duration-500`}
                ...
                <div className="flex flex-wrap gap-2">
                  {priceRanges.map((range) => (
                    ...
                    >
                      ...
                      <div
                        className={`absolute -inset-0.5 bg-gradient-to-r from-green-500 to-emerald-600 rounded-lg blur opacity-0 ${
                          priceRange === range.id
                            ? "opacity-20"
                            : "group-hover:opacity-10"
                        } transition-opacity duration-500`}
